...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container px-6 py-8 mx-auto">
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-lg font-semibold text-gray-700 capitalize">TAMBAH CAMPAIGN</h2>
            <hr class="mt-4">
            <form action="{{ route('admin.campaign.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input class="w-full mt-2 bg-gray-200 rounded-md form-input focus:bg-white" type="text" name="title" value="{{ old('title') }}" placeholder="Judul Campaign">
                        @error('title')
                            <div class="w-full mt-2 overflow-hidden bg-red-200 rounded-md shadow-sm">
                                <div class="px-4 py-2">
                                    <p class="text-sm text-gray-600">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input class="w-full p-3 mt-2 bg-gray-200 rounded-md form-input focus:bg-white" type="number" name="target_donation" value="{{ old('target_donation') }}" placeholder="Target Donasi, Ex: 10000000">
                    ...
                    <div>
                        ...
                        <input class="w-full p-3 mt-2 bg-gray-200 rounded-md form-input focus:bg-white" type="date" name="max_date" value="{{ old('max_date') }}">
                        @error('max_date')
                            <div class="w-full mt-2 overflow-hidden bg-red-200 rounded-md shadow-sm">
                                <div class="px-4 py-2">
                                    <p class="text-sm text-gray-600">{{ $message }}</p>
