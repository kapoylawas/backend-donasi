                        ...
                        @forelse($campaigns as $campaign)
                            <tr class="bg-white border">
                                ...
                                <td class="px-10 py-2 text-center">
                                    <a href="{{ route('admin.campaign.edit', $campaign->id) }}" class="px-4 text-white bg-indigo-600 rounded shadow-sm text-small focus:outline-none">EDIT</a>
                                    <button onClick="destroy(this.id)" id="{{ $campaign->id }}" class="px-4 text-white bg-red-600 rounded shadow-sm text-small focus:outline-none">HAPUS</button>
                                </td>
                            </tr>
                        @empty
