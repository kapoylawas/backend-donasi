...
<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-300">
    <div class="container px-6 py-8 mx-auto">
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            <h2 class="text-lg font-semibold text-gray-700 capitalize">EDIT KATEGORI</h2>
            <hr class="mt-4">
            <form action="{{ route('admin.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        ...
                        <input class="w-full mt-2 bg-gray-200 rounded-md form-input focus:bg-white" type="text" name="name" value="{{ old('name', $category->name) }}" placeholder="Nama Kategori">
                        @error('name')
